...
//
window.__appendTemplate('\n<div data-bind="pane: \'/Common/tooltip\', data: { html: $data.field.error, autoShow: true, position: \'right\' }"></div>', 'template--Forms-validationMessage');
