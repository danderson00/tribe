...
$('head')
    .append('<script type="text/template" id="template--Content-About-contribute"><div class="content block">\n    <h1>Contribute</h1>\n    <h2>Tribe needs you!</h2>\n    <p>\n        There are many cool things on the roadmap for the Tribe platform like mobile device skins for each platform,\n        seamless scale-out of the MessageHub component, better distributed event sourcing support, Azure Mobile Services \n        integration and much more.\n    </p>\n    <p>\n        If you\'d like to get involved, please email <a href="mailto:tribejs@gmail.com">tribejs@gmail.com</a>,\n        tweet <a href="http://twitter.com/tribejs" target="_blank">@tribejs</a> or use the feedback button at the top of the page.\n    </p>\n</div></script>');
$('head')
...
$('head')
    .append('<script type="text/template" id="template--Interface-tip"><div class="tip">\n    <img src="Images/icon.tip.64.png"/>\n    <p>\n        <b>TIP:</b> <span data-bind="text: pane.data.tip"></span>\n    </p>\n    <div class="clear"></div>\n</div>\n</script>');
$('head')
...
$('<style/>')
    .attr('class', '__tribe')
    .text('.tip{background:#ded;padding:0 10px;margin:10px 0;border-radius:8px}.tip p{display:table-cell;vertical-align:middle;height:70px}.tip img{float:left;border:none;margin:5px 10px 5px -10px;padding:0}')
    .appendTo('head');
$('<style/>')
    .attr('class', '__tribe')
...
$('<style/>')
    .attr('class', '__tribe')
    .text('body{background:#ccc;font-family:\'Segoe UI\',\'Trebuchet MS\',Arial,Helvetica,Verdana,sans-serif;padding:0;margin:0;overflow-y:scroll}h1,h2,h3{margin-top:0}b{color:#103070}.padded{padding:10px}.underline{text-decoration:underline}.clear{clear:both}a,a:active,a:visited,a:link{text-decoration:none;cursor:pointer;color:#1b50ba}a:hover{text-decoration:underline}table{border-spacing:0;border-collapse:collapse}table.pointer tr:hover{background:#103070;color:#fff}table.pointer tr{cursor:pointer}th{text-align:left;background:#457ae4;color:#fff;padding:2px 5px}th,td{border:1px solid #457ae4;padding:2px 5px}pre.inline{display:inline-block}button{text-decoration:none;text-align:center;padding:11px 32px;border:solid 1px #004f72;-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:4px;font:18px Arial,Helvetica,sans-serif;font-weight:bold;color:#e5ffff;background-color:#103070;background-image:-moz-linear-gradient(top,#103070 0%,#1b50ba 100%);background-image:-webkit-linear-gradient(top,#103070 0%,#1b50ba 100%);background-image:-o-linear-gradient(top,#103070 0%,#1b50ba 100%);background-image:-ms-linear-gradient(top,#103070 0%,#1b50ba 100%);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=\'#1b50ba\',endColorstr=\'#1b50ba\',GradientType=0);background-image:linear-gradient(top,#103070 0%,#1b50ba 100%);-webkit-box-shadow:0 0 2px #bababa,inset 0 0 1px #fff;-moz-box-shadow:0 0 2px #bababa,inset 0 0 1px #fff;box-shadow:0 0 2px #bababa,inset 0 0 1px #fff}button:hover{background:#103070}button:active{background:#1b50ba}')
    .appendTo('head');
$('<style/>')
    .attr('class', '__tribe')
