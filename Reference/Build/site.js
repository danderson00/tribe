...
window.__appendTemplate('<div data-bind="pane: \'/Interface/API/type\', data: Reference.PubSub"></div>', 'template--Content-Reference-PubSub-core');//
...
window.__appendTemplate('<div data-bind="pane: \'/Mobile/main\', data: { pane: \'/About/Mobile/welcome\' }"></div>', 'template--Samples-mobile');//
window.__appendTemplate('<div data-bind="pane: \'sender\'"></div>\n<div data-bind="pane: \'messages\'"></div>', 'template--Samples-About-Chat-chat');//
window.__appendTemplate('<ul class="messages" data-bind="foreach: messages">\n    <li>\n        <span data-bind="text: name"></span>:\n        <span data-bind="text: message"></span>\n    </li>\n</ul>\n', 'template--Samples-About-Chat-messages');//
...
window.__appendStyle('.browsers.block{padding-bottom:0}.browsers .features{border:none}');//
window.__appendStyle('.example3 .sample .samplePane{padding:0;width:320px;height:480px;left:22px;top:136px}.example3 .sample>*{height:711px}.example3 .sample .source{width:548px}.example3 .sample .result{width:365px;height:721px;border:none;background:url(\'Images/device.mobile.png\');margin-left:15px}.example3 .sample .fileList{width:548px;height:auto}.example3 .sample .fileContent{width:548px;height:auto}.example3 .result .title{display:none}');//
...
window.__appendStyle('.knockout.block{text-align:center;background:center url(\'Images/knockout/background.jpg\')}.knockout .features{display:inline-block;margin-left:50px;background-clip:padding-box;color:#b64838}.knockout .logo{color:#fff;vertical-align:top;margin-top:20px;display:inline-block;width:250px;font:inherit}');//
window.__appendStyle('.masthead{color:#fff;text-shadow:3px 3px 0 black,5px 5px 5px rgba(0,0,0,.5);background:#103070;text-align:center;padding-bottom:20px;border-bottom:1px #333 solid}.masthead h1{height:60px;font-size:96pt;padding:0}.masthead h2{font-size:18px}');//
...
window.__appendStyle('.tip{background:#ded;padding:0 10px;margin:10px 0;border-radius:8px}.tip p{display:table-cell;vertical-align:middle;height:70px}.tip img{float:left;border:none;margin:5px 10px 5px -10px;padding:0}');//
...
window.__appendStyle('ul.welcome li{background:#103070;color:#fff;text-align:center;text-shadow:3px 3px 0 black,5px 5px 5px rgba(0,0,0,.5);font:bold 64pt \'Cambria\'}');//
window.__appendStyle('.taskList{list-style:none;padding:0}.taskList li{padding:5px}');//
window.__appendStyle('.panels>div{margin-bottom:5px;border:1px solid #000}');//
