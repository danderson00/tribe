suite('tribe.load', function () {
    ...
    test("loading a file executes content", function () {
        return load.file(__dirname + '/../load/basic/test.js')
            .then(function (value) {
    ...
    test("loading a directory executes all content", function () {
        return load.directory(__dirname + '/../load/basic')
    ...
    test("load includes require, __dirname and __filename arguments", function () {
        return load.file(__dirname + '/../load/args/builtins.js')
            .then(function (value) {
    ...
    test("require operates as expected from a loaded file", function () {
        ...
        return load.file(__dirname + '/../load/args/require.js')
            .then(function (value) {
    ...
    test("arguments passed to load are available in loaded file", function () {
        return load.file({ path: __dirname + '/../load/args/customArg.js', args: { customArg: 'test' } })
            .then(function (value) {
                expect(value).to.equal('test');
            });
    });
    ...
    test("requireExtensions are extended onto local require function", function () {
        var spy = sinon.spy();
        return load.file({ path: __dirname + '/../load/args/requireExtensions.js', requireExtensions: { test: spy } })
            .then(function () {
