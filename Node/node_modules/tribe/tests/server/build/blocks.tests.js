...
suite('tribe.build.blocks', function () {
    ...
    test("addFilesToContext filters files if requested", function () {
        return getBlock('addFilesToContext')('test', targetPath('simple'), /child/)(context)
            .then(function () {
    ...
    test("addFilesToContext excludes content if requested", function () {
        return getBlock('addFilesToContext')('test', targetPath('simple'), null, false)(context)
            .then(function () {
                expect(context.test.length).to.equal(3);
    ...
    test("browserify", function () {
        return getBlock('addFilesToContext')('test', targetPath('browserify'), null, false)(context)
            .then(function () {
