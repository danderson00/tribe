...
<head>
    ...
    <script type="text/javascript" src="knockout/knockout-latest.debug.js"></script>
    <script type="text/javascript" src="socket.io/socket.io.js"></script>
    <script type="text/javascript" src="composite/Tribe.Composite.debug.js"></script>
    <% } else { %>
    <script type="text/javascript" src="jquery/jquery.min.js"></script>
    <script type="text/javascript" src="knockout/knockout-latest.js"></script>
    <script type="text/javascript" src="socket.io/socket.io.min.js"></script>
    <script type="text/javascript" src="composite/Tribe.Composite.min.js"></script>
    <% } %>
