...
module.exports = {
    ...
    listTree: function (directoryPath, recursive) {
    ...
    enumerateFiles: function (directoryPath, callback, recursive) {
        // need to require here to avoid issues with circular dependency
        var utils = require('tribe/utilities'),
        directoryPath = path.normalize(directoryPath);
        return module.exports.listTree(directoryPath, recursive)
