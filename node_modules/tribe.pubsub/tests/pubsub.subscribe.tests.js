suite('tribe.pubsub.subscribe', function () {
    ...
    test('subscribe.to with property filter only executes handlers when property matches', function () {
        var spy = sinon.spy();
        pubsub.subscribe.to('test').when('property').equals('test').execute(spy);
