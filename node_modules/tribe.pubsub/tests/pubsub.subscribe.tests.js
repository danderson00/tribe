suite('tribe.pubsub.subscribe', function () {
    ...
    test('passing array of topics to subscribe returns correct number of string tokens', function () {
    ...
    test('passing array of topics to subscribe correctly subscribes messages', function () {
        var spy = sinon.spy();
    ...
    test('passing array of handlers to subscribe correctly subscribes and unsubscribes messages', function () {
        var spy = sinon.spy(),
            token = pubsub.subscribe('test', [spy, spy]);
        ...
        pubsub.publishSync('test');
        assert.ok(spy.calledTwice, "Both subscriptions removed");
    });
