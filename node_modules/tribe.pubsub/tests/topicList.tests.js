suite('tribe.pubsub.topicList', function() {
    ...
    test("get returns default handlers when mixed with property filters", function () {
        ...
        var token2 = list.add("0", "1", "property", { property: 'data.test', value: 1 });
        list.add("0", "2", "property", { property: 'data.test', value: 1 });
        list.add("0", "3", "property", { property: 'data.test', value: 2 });
        list.add("2", "4");
