suite('tribe.pubsub.actor.scope', function () {
    ...
    test("actor only handles messages with provided scope", function () {
        var actor1 = new actorModule(pubsub, factory(spy1), { test: 1 }),
            actor2 = new actorModule(pubsub, factory(spy2), { test: 2 });

        function factory(handler) {
            return function(actor) {
                actor.handles({ 'testTopic': handler })
            };
        }
