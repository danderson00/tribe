suite('tribe.pubsub.actor', function () {
    ...
    test("pre and post message handlers are executed for each handled message", function () {
        ...
        assert.ok(actor.preMessage.calledTwice);
        assert.ok(actor.postMessage.calledTwice);
    });
    ...
    test("pre and post message handlers are executed when defined in constructor", function () {
        ...
        assert.ok(pre.calledTwice);
        assert.ok(post.calledTwice);
    ...
    test("actor only handles messages with mapped id property", function () {
        ...
        actor1.mapsIdToMessageProperty('test');
        actor1.start();
        actor2.mapsIdToMessageProperty('test');
        actor2.start();
