...
// this exists mostly for backwards compatibility with the actor server operation, used by test-studio
...
actor.prototype.publish = function (topicOrEnvelope, data) {
    if(['server', 'replay'].indexOf(this.handlerContext.origin) === -1 && !this.handlerContext.silent)
