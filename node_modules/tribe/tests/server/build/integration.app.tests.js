// this is getting complex, slow and problematic...
...
//         var memory = require('tribe/server/modules/memory');
...
//                 expect(js).to.have.string("window.scriptEnvironment = { resourcePath: '/resource' };");    //build/blocks/browserify.js
//                 expect(js).to.have.string('facets.register');                                           //client/register.js
//                 expect(js).to.have.string('//# sourceURL=');                                            //build/activities/app.js /utilities/browserify.js
//                 expect(js).to.have.string('var gateway = module.exports');                                  //client/gateway.js
