suite('tribe.build.blocks', function () {
    ...
    test("browserify", function () {
        return getBlock('addFilesToContext')('test', targetPath('browserify'), null, false)(context, b)
            .then(function () {
                return getBlock('addFilesToContext')('test2', targetPath('browserify2'), null, false)(context, b)
            })
            .then(function () {
                return getBlock('browserify')(['test', 'test2']).to()(context, b);
            })
            .then(function (result) {
                expect(result).to.have.string('//1');
