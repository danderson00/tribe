...
suite('tribe.utilities.paths', function () {
    ...
    test("ensureConsistentDrive makes all windows drive letters lower case", function () {
        expect(paths.ensureConsistentDrive('C:\\test\\test.js')).to.equal('c:\\test\\test.js');
        expect(paths.ensureConsistentDrive('c:\\test\\test.js')).to.equal('c:\\test\\test.js');
        expect(paths.ensureConsistentDrive('/test/test.js')).to.equal('/test/test.js');
    });
});