...
// ﻿suite('tribe.client.bindingHandlers.facet', function () {
//     test("facet is obtained and bound before renderOperation completes", function () {
...
//     });
//
//     test("facet responds to messages after binding", function () {
//         var node = T.createNode('body', { path: '/tests/browserTest' });
//         return node.pane.is.rendered.then(function () {
