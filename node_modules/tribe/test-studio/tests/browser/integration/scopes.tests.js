suite('tribe.browser.integration.scopes', function () {
    ...
    // the required delay here indicates a problem - we're going to get duplicated messages
    ...
    test("server releases client scopes", function () {
        var scope = { facetId: uuid() },
            received;
        ...
        return scopes.request(scope)
            ...
            .then(delay(100))
            .then(function () {
                if(received) throw new Error('message received after scope released');
            });
    });
