...
build.activities.register('app', function () {
    ...
    return {
        render: function (context, buildOptions) {
            build.blocks('startup')(context, buildOptions);
            ...
            function configure(b, files) {
                ...
                b.require(require.resolve('tribe/client/register'), { expose: 'tribe/register' });
                ...
                b.require(require.resolve('tribe/facets'), { expose: 'tribe/facets' });

                b.transform(utils.streams.throughTransform(function (source, file) {
                    if(source && options.babel && file.resourcePath)
                        source = babel.transform(source, options.babel).code;
                    ...
                    return file.resourcePath ? "window.scriptEnvironment = { resourcePath: '" + file.resourcePath + "' };" + source : source;
                }, files));
            }
        },
