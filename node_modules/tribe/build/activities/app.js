...
build.activities.register('app', function () {
    return {
        render: function (context) {
            ...
            build.blocks('renderTemplate')('app').to('app.htm', 'app')(context);
            build.blocks('combineContents')('css').to('app.css', 'app')(context);

            return build.blocks('browserify')('js', configure).to('app.js', 'app')(context);
        },
        output: function (context) {
            memory.register('app', context.app);
        }
    };
});

function configure(b, files) {
    b.require('tribe/client', { expose: 'tribe' });
