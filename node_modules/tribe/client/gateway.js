...
var gateway = module.exports = {
    connect: function () {
        ...
        // move publish.subscribe section from scopes.relayAndStore here
        // publish message to server, then store locally for each matching registered scope
    },
    ...
    scope: {
        request: function (options) {
            // register and count this request, like in scopes
            return defer('scope', options);
        },
        release: function (options) {
            // reduce count of times this scope is tracked by one
            // release from server if 0
            // the server side release is not implemented
        }
    },
