    ...
    request: function (scope) {
        ...
        return store.retrieve(scope)
            .then(function (localMessages) {
                ...
                log.silly("Retrieved " + messages.length + " messages from local cache with last seq " + lastLocalSeq + " for scope " + JSON.stringify(scope));
            ...
            .then(function (scopeEnvelopes) {
                log.silly("Retrieved " + (scopeEnvelopes ? scopeEnvelopes.length : 0) + " messages from server for scope " + JSON.stringify(scope));
