...
pubsub.prototype.obtainActor = function (path, id) {
    ...
    return loadDependencies(this, path, id)
        .then(function (dependencies) {
            actor = actors.create(self, path, id, dependencies);
...
function loadDependencies(pubsub, path, id) {
    ...
    var promises = $.map(definition.dependencies, function (dependency) {
        return pubsub.obtainActor(dependency, id).then(function (instance) {
...
function attachToHub(path, actor, replay) {
    ...
    return hub.actor({ actor: path, id: actor.id, replay: replay });
}
