...
var options = module.exports = {
    ...
    server: {
        modules: [
            ...
            modules.fs('/dependencies/knockout/', path.resolve(modulePath(), 'node_modules/knockout/build/output')),
            modules.fs('/dependencies/jquery/', path.resolve(modulePath(), 'node_modules/jquery/dist')),
            modules.fs('/dependencies/socket.io/', path.resolve(modulePath(), 'node_modules/socket.io-client')),
            modules.fs('/dependencies/composite/', path.resolve(modulePath(), 'node_modules/tribe.composite/Build')),
