...
suite('tribe.rx.actor.extensions.messages', function () {
    ...
    test("messages returns rx observable linked to actor pubsub", function () {
        var actor = new Actor(pubsub),
    ...
    test("envelopes returns rx observable linked to actor pubsub", function () {
        var actor = new Actor(pubsub),
            observable = actor.envelopes,
            spy = sinon.spy()
