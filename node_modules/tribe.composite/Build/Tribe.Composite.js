...
(function (global) {
    ...
    $(function() {
        $('head').append('<style class="__tribe">' +
                         '.__rendering { position: fixed; top: -10000px; left: -10000px; }' +
                         '.__transitionFilter { position: fixed; left: 0; top: 0; right: 0; bottom: 0; z-index: 9999; display: none }</style>')
        $('body').append('<div class="__transitionFilter"></div>');
    });
...
T.Types.Pane.prototype.startFacet = function(path, args) {
    var facet = T.context().facets[path];
    this.pubsub.startFacet.apply(this.pubsub, [facet.constructor].concat(Array.prototype.slice.call(arguments, 1)));
};
...
// Types/StringCollection.js
T.Types.StringCollection = function (initialContent) {
...
// Events/paneRendered.js
T.Events.paneRendered = function (pane, context) {
...
(function () {
    ...
    T.registerFacet = function () {
        addResource('facets', T.Utils.arguments(arguments));
    };
