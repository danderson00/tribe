...
test("pane is scoped to value specified in pane options", function () {
    ...
    rootPubsub.publishSync('topic');
    equal($('#count').text(), '1');

    rootPubsub.publishSync('topic', { value: 'test' });
    equal($('#count').text(), '2');

    // outside of current scope
    pubsub.publishSync('topic', { value: 'test2' });
    equal($('#count').text(), '2');
...
test("pane is scoped to value specified in binding handler", function () {
    ...
    pubsub.publishSync('topic', { value2: 'test2' });
    equal($('#count').text(), '1');
});
...
test("scope cascades through panes", function () {
    ...
    pubsub.publishSync('topic', { value: 'test', value2: 'test2' });
    equal($('#count').text(), '1');
});
