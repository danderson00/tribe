...
$.mockjax({
    url: 'Integration/Panes/Navigate/observable.htm',
    responseText: '<div class="observable">\n    <div data-bind="pane: currentPane, handlesNavigation: true"></div>\n</div>\n',
    responseTime: 0
});
$.mockjax({
    url: 'Integration/Panes/Navigate/observable.js',
    responseText: 'T.registerModel(function (pane) {\n    this.currentPane = ko.observable(\'content1\');\n});\n',
    responseTime: 0
});
$.mockjax({
    url: 'Integration/Panes/Navigate/virtual.htm',
    responseText: '<div class="virtual">\n    <!-- ko pane: currentPane, handlesNavigation: true -->\n    <!-- /ko -->\n</div>\n',
    responseTime: 0
});
$.mockjax({
    url: 'Integration/Panes/Navigate/virtual.js',
    responseText: 'T.registerModel(function (pane) {\n    this.currentPane = ko.observable(\'content1\');\n});\n',
    responseTime: 0
});
$.mockjax({
...
$.mockjax({
    url: 'Integration/Panes/Scope/child.htm',
    responseText: '<span id="count" data-bind="text: scopeCount"></span>\n<div data-bind="pane: \'reset\', scope: \'reset\', data: \'reset\'"></div>\n<div data-bind="pane: \'reset\', scope: { value2: \'test2\' }, resetScope: true, data: \'resetScope\'"></div>\n',
    responseTime: 0
});
$.mockjax({
    url: 'Integration/Panes/Scope/child.js',
    responseText: 'T.registerModel(function (pane) {\n    var self = this;\n\n    this.scopeCount = ko.observable(0);\n\n    pane.pubsub.subscribe(\'topic\', function () {\n        self.scopeCount(self.scopeCount() + 1);\n    })\n})\n',
    responseTime: 0
});
$.mockjax({
    url: 'Integration/Panes/Scope/middle.htm',
    responseText: '<div data-bind="pane: \'child\', scope: { value2: \'test2\' }"></div>\n',
    responseTime: 0
});
$.mockjax({
    url: 'Integration/Panes/Scope/parent.htm',
    responseText: '<div data-bind="pane: \'middle\', scope: { value: \'test\' }"></div>\n',
    responseTime: 0
});
$.mockjax({
    url: 'Integration/Panes/Scope/reset.htm',
    responseText: '<span data-bind="attr: { id: elementId }, text: count"></span>\n',
    responseTime: 0
});
$.mockjax({
    url: 'Integration/Panes/Scope/reset.js',
    responseText: 'T.registerModel(function (pane) {\n    var self = this;\n\n    this.count = ko.observable(0);\n    this.elementId = pane.data + "TotalCount";\n\n    pane.pubsub.subscribe(\'topic\', function () {\n        self.count(self.count() + 1);\n    })\n})\n',
    responseTime: 0
});
$.mockjax({
...
$.mockjax({
    url: 'Integration/Panes/Virtual/child.htm',
    responseText: '<div class="child"></div>\n',
    responseTime: 0
});
$.mockjax({
    url: 'Integration/Panes/Virtual/parent.htm',
    responseText: '<!-- ko pane: \'child\' -->\n<!-- /ko -->\n',
    responseTime: 0
});
...
$.mockjax({ url: 'Integration/Panes/Navigate/observable.css', status: 404, responseTime: 0 });
$.mockjax({ url: 'Integration/Panes/Navigate/virtual.css', status: 404, responseTime: 0 });
...
$.mockjax({ url: 'Integration/Panes/Scope/child.css', status: 404, responseTime: 0 });
$.mockjax({ url: 'Integration/Panes/Scope/middle.js', status: 404, responseTime: 0 });
$.mockjax({ url: 'Integration/Panes/Scope/middle.css', status: 404, responseTime: 0 });
$.mockjax({ url: 'Integration/Panes/Scope/parent.js', status: 404, responseTime: 0 });
$.mockjax({ url: 'Integration/Panes/Scope/parent.css', status: 404, responseTime: 0 });
$.mockjax({ url: 'Integration/Panes/Scope/reset.css', status: 404, responseTime: 0 });
...
$.mockjax({ url: 'Integration/Panes/Virtual/child.js', status: 404, responseTime: 0 });
$.mockjax({ url: 'Integration/Panes/Virtual/child.css', status: 404, responseTime: 0 });
$.mockjax({ url: 'Integration/Panes/Virtual/parent.js', status: 404, responseTime: 0 });
$.mockjax({ url: 'Integration/Panes/Virtual/parent.css', status: 404, responseTime: 0 });
