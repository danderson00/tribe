...
},{"./facet.addHandler":9,"./utils":21,"tribe.expressions":5}],11:[function(require,module,exports){
if (typeof Tribe === "undefined") Tribe = {};
Tribe.PubSub = require('./pubsub');
Tribe.PubSub.Facet = require('./facet');
},{"./facet":10,"./pubsub":17}],12:[function(require,module,exports){
...
lifetime.prototype.startFacet = function (definition, data) {
    return new facet(this, definition).start(data);
};
...
},{"./facet":10,"./channel":12,"./utils":21,"tribe.expressions":5}],16:[function(require,module,exports){
var utils = require('./utils');
...
pubsub.prototype.startFacet = function (definition, data) {
    return new facet(this, definition).start(data);
};

},{"./facet":10,"./channel":12,"./lifetime":15,"./options":16,"./subscribeOnce":18,"./subscribeTo":19,"./topicList":20,"./utils":21}],18:[function(require,module,exports){
