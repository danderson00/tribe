...
module.exports = function (data, options) {
    ...
    var x = {
            max: d3.max(data.map(function (points) { 
                return d3.max(points.map(function (point) { 
                    return point[0] 
                }))
            })),
            min: d3.min(data.map(function (points) { 
                return d3.min(points.map(function (point) { 
                    return point[0] 
                }))
            }))
        },
