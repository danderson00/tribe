...
$.mockjax({
    ...
    responseText: '\n<div data-bind="pane: \'basic\'" class="basicContainer">\n</div>',
    responseTime: 0
});
...
$.mockjax({
    ...
    responseText: '\n<div class="parent" data-bind="pane: \'child\'">\n\n</div>',
    responseTime: 0
});
